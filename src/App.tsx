...
export default function App() {
  ...
  // Restaurar sessão do Supabase no carregamento
  useEffect(() => {
  ...
  return (
    <div className="flex min-h-screen bg-bg-dark text-slate-100 selection:bg-primary/30">
      ...
      <GlobalModals 
        ...
        confirmDeleteCustomerWithPayments={confirmDeleteCustomerWithPayments}
        handleUnlockSettings={handleUnlockSettings}
        handleAddTransaction={handleAddTransaction}
        handleDeleteTransaction={handleDeleteTransaction}
        confirmDeleteClientPayment={confirmDeleteClientPayment}
